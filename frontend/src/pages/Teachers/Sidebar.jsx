    ...
    <SidebarContainer style={{ width: isOpen ? '250px' : '80px' }}>
      ...
      <SidebarNav>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/teacher/lesson-plans">Lesson Plans</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsPeople /></SidebarIcon>
          <StyledLink to="/teacher/students-progress">Students Progress</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsPeople /></SidebarIcon>
          <StyledLink to="/teacher/students-progress">Assessments</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/teacher/performance">Performance Data</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/teacher/settings">Settings</StyledLink>
        </SidebarNavItem>
